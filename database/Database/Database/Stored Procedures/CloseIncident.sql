CREATE procedure [dbo].[CloseIncident](@incident int, @close_description varchar(max) = null, 
	@responsible_id int = null, @title varchar(400) = '', @payment_method_id int = null)                  
as                  
begin               
