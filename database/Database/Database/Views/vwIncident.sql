...
with schemabinding                                          
as                                            
 select i.id, LEFT(CONVERT(VARCHAR(15), i.[date], 103), 5) small_date, isnull(cast(i.title as varchar(max)), i.[description]) title,                  
 ...
 eit.need_to_be_started, i.close_text, i.cancelled, i.branch_id, b.name branch_name, b.initials branch_initials,                                    
 ...
 i.payment_method_id, pm.[name] payment_method          
