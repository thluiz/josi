...
function configure_routes(app, connection_pool) {
    ...
    app.get("/api/financial_board/expected_payments/:account", auth.ensureLoggedIn(), (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        const result = yield new sql.Request(pool)
    ...
    app.get("/api/financial_board/account_status/:account", auth.ensureLoggedIn(), (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        const result = yield new sql.Request(pool)
            .input("account_id", sql.Int, req.params.account)
            .input("start_date", sql.VarChar(10), req.query.start || null)
            .input("end_date", sql.VarChar(10), req.query.end || null)
    ...
    app.get("/api/financial_board/missing_payments/:account", auth.ensureLoggedIn(), (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        const result = yield new sql.Request(pool)
            .input("account_id", sql.Int, req.params.account)
    ...
    app.post("/api/financial/accounts", auth.ensureLoggedIn(), (req, res, next) => __awaiter(this, void 0, void 0, function* () {
