...
var PersonFinancialTreatmentModalComponent = /** @class */ (function () {
    function PersonFinancialTreatmentModalComponent(personService, parameterService, utilsService, incidentService, ngbModalService, datePickerConfig) {
        ...
        this.branches = [];
        this.without_schedule_payments = false;
        this.contacts = [];
    ...
    PersonFinancialTreatmentModalComponent.prototype.person_id = function () {
        if (!this.person) {
    ...
    PersonFinancialTreatmentModalComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    PersonFinancialTreatmentModalComponent.prototype.ngOnDestroy = function () {
        this.person_changes_subscriber.unsubscribe();
        this.incident_changes_subscriber.unsubscribe();
    };
    PersonFinancialTreatmentModalComponent.prototype.open = function (person) {
        var _this = this;
        this.person = person;
        Observable_1.Observable.zip(this.personService.getPendingFinancial(this.person_id()), this.personService.getPersonContacts(this.person_id()), this.parameterService.getActiveBranches(), function (pending_data, contacts, branches) {
            _this.pending = pending_data.pending[0];
            _this.without_schedule_payments = pending_data.pending[0].without_schedule_payments;
            ...
            _this.open_modal(_this.financial_treatment_modal, true);
        }).subscribe();
    };
    PersonFinancialTreatmentModalComponent.prototype.open_new_contact = function (content) {
        var _this = this;
        this.parameterService.getContactTypes().subscribe(function (data) {
            _this.open_modal(content);
        });
    };
    PersonFinancialTreatmentModalComponent.prototype.open_modal = function (content, on_close_action) {
    ...
    PersonFinancialTreatmentModalComponent.prototype.load_data = function () {
        var _this = this;
        this.personService.getPendingFinancial(this.person_id()).subscribe(function (missing_data) {
            _this.pending = missing_data;
        });
    };
    PersonFinancialTreatmentModalComponent.prototype.load_contacts = function (contacts) {
    ...
    __decorate([
        core_1.ViewChild('financial_treatment_modal'),
        __metadata("design:type", core_1.ElementRef)
    ], PersonFinancialTreatmentModalComponent.prototype, "financial_treatment_modal", void 0);
    PersonFinancialTreatmentModalComponent = __decorate([
        core_1.Component({
    ...
    return PersonFinancialTreatmentModalComponent;
    var _a, _b, _c, _d;
}());
exports.PersonFinancialTreatmentModalComponent = PersonFinancialTreatmentModalComponent;
//# sourceMappingURL=person-financial-treatment-modal.component.js.map