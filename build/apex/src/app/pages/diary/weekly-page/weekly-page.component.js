...
var lateral_summary_component_1 = require("app/shared/components/lateral-summary/lateral-summary.component");
var WeeklyPageComponent = /** @class */ (function () {
    function WeeklyPageComponent(personService, incidentService, securityService, modalService, datePickerConfig, route, router) {
        var _this = this;
    ...
    WeeklyPageComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    WeeklyPageComponent.prototype.ngOnDestroy = function () {
        if (this.update_members_timer) {
            clearTimeout(this.update_members_timer);
        }
    };
    WeeklyPageComponent.prototype.branchSelected = function (id) {
        var _this = this;
        clearTimeout(this.update_members_timer);
    ...
    WeeklyPageComponent.prototype.change_week = function (modifier) {
        clearTimeout(this.update_members_timer);
        this.update_members_timer = null;
        this.current_week += modifier;
        this.getMonitorData();
    };
    WeeklyPageComponent.prototype.updateMonitorData = function () {
        this.personService.getDailyMonitor(this.current_branch, person_service_1.DailyMonitorDisplayType.Week, this.current_week).subscribe(function (data) {
            var result = data;
            for (var w = 0; w < result.domains.length; w++) {
            }
        });
    };
    WeeklyPageComponent.prototype.getMonitorData = function () {
        var _this = this;
        this.personService.getDailyMonitor(this.current_branch, person_service_1.DailyMonitorDisplayType.Week, this.current_week).subscribe(function (data) {
            var result = data;
            console.log(result);
    ...
    WeeklyPageComponent.prototype.load_external_people = function (result) {
        var _this = this;
    ...
    ], WeeklyPageComponent.prototype, "lateralSummaryComponent", void 0);
    WeeklyPageComponent = __decorate([
        core_1.Component({
    ...
    return WeeklyPageComponent;
    var _a, _b, _c;
}());
exports.WeeklyPageComponent = WeeklyPageComponent;
//# sourceMappingURL=weekly-page.component.js.map